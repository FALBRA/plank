...
<div class="arriba">
    ...
    <p>Diseño, desarrollo e implementación de paginas web, aquí lo que ofrecemos</p>
</div>
<section class="paquetes">
    <div class="desarrollo-web-basico">
        <div class="desarrollo-web-nombre">
        ...
        <div class="desarrollo-web-beneficio">
            <h2 class="negrita">Beneficios clave:</h2>
